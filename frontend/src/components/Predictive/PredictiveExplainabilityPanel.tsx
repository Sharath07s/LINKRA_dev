  ...
  return (
    <div className="h-full bg-[#080808] border border-[#222222] rounded-xl flex flex-col overflow-hidden">
      <div className="p-3 border-b border-[#222222] bg-[#050505]/50 flex items-center gap-2">
        <ScanSearch className="h-4 w-4 text-[#10B981]" />
        <h3 className="text-xs font-bold text-[#F5F5F5] uppercase tracking-widest">Explainability Engine</h3>
      </div>
      ...
      <div className="flex-1 p-4 overflow-y-auto relative">
        {isInsufficient || !expPreview ? (
          <div className="h-full flex flex-col justify-center items-center text-center">
            ...
            <p className="text-xs text-[#9A9A9A] font-mono">Cannot compute confidence on missing baselines.</p>
          </div>
        ) : (
          <div className="h-full flex flex-col">
            <p className="text-[10px] text-[#666666] uppercase tracking-widest mb-3">Model Preview: Crime Forecaster</p>
            <ConfidenceBreakdown 
