  ...
  return (
    <div className="h-full bg-[#080808] border border-[#222222] rounded-xl flex flex-col overflow-hidden">
      <div className="p-3 border-b border-[#222222] bg-[#050505]/50 flex items-center gap-2">
        ...
        <h3 className="text-xs font-bold text-[#F5F5F5] uppercase tracking-widest">Emerging Hotspots</h3>
      </div>
        ...
        {isInsufficient ? (
          <div className="h-full flex flex-col justify-center items-center text-center">
            ...
            <div className="inline-flex items-center gap-2 text-[10px] bg-[#050505] px-2 py-1 rounded border border-[#222222]">
              <span className="text-[#666666]">Available Coords: {data.available_records}</span>
            </div>
          </div>
        ) : (
          <div className="space-y-3">
            {data?.predicted_hotspots?.map((hs: any, i: number) => (
              <div key={i} className="bg-[#050505] border border-amber-500/20 rounded p-3">
