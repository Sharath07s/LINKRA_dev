...
export default function AITimelineAnalysisPanel({ entityType, entityId }: AITimelineAnalysisProps) {
  ...
  return (
    <div className="bg-[#080808]/40 border border-[#222222] rounded-2xl h-full flex flex-col overflow-hidden relative">
      ...
      <div className="p-4 border-b border-[#222222] bg-[#050505]/40 flex items-center justify-between">
      ...
      <div className="p-5 flex-1 overflow-y-auto space-y-5">
        <div>
          <span className="text-[10px] font-bold text-[#666666] uppercase tracking-widest block mb-2">Chronological Synthesis</span>
        ...
        <div className="grid grid-cols-1 gap-3">
          <div className="bg-[#050505]/60 border border-[#222222] p-3 rounded-xl flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-[#F5F5F5]">{data.behavioral_changes}</p>
            </div>
          </div>
          ...
          <div className="bg-[#050505]/60 border border-[#222222] p-3 rounded-xl flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-[#F5F5F5]">{data.escalation_patterns}</p>
            </div>
          </div>
          ...
          <div className="bg-[#050505]/60 border border-[#222222] p-3 rounded-xl flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-[#F5F5F5]">{data.repeat_offender_indicators}</p>
            </div>
          </div>
        </div>

        <div>
          <span className="text-[10px] font-bold text-[#666666] uppercase tracking-widest block mb-2">Key Extracted Events</span>
          <ul className="space-y-2">
            {data.key_events?.map((evt: string, idx: number) => (
              <li key={idx} className="flex items-center gap-2 text-xs text-[#F5F5F5]">
